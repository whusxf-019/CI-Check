...
public class CircleAlarmTimerView extends View {
    ...
    private static final int DEFAULT_LINE_COLOR = 0xFFFECE02;//滑动的线
    private static final int DEFAULT_HIGHLIGHT_LINE_COLOR = 0xFF68C5D7;
    private static final int DEFAULT_NUMBER_COLOR = 0xFF9E9E9E;//圆环的背景色
    private static final int DEFAULT_TIMER_NUMBER_COLOR = 0xFF000000;
    private static final int DEFAULT_TIMER_COLON_COLOR = 0xFFFF4081;
