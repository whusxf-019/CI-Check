                            ...
                            if(msg.what==1){
                                ...
                                dialog.setPositiveButton("确认", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                       // Intent intent = new Intent(RegisterActivity.this,FaceIdentityActivity.class);
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            case R.id.bt_activity_register_button:
                ...
                if(name.getText().toString().equals(password.getText().toString())){
                    //转转转
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            map.put("userAccount", account.getText().toString());
                            try {
                                map.put("userName", URLEncoder.encode(password_again.getText().toString(),"utf-8"));
                                String te=URLEncoder.encode(password_again.getText().toString(),"utf-8");
                            } catch (UnsupportedEncodingException e) {
                                e.printStackTrace();
                            }
                            map.put("password", name.getText().toString());
