...
public class UserMapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new aaa(pieChart2,pieChart1,barChart,xAxis).execute();
...
//            nf.setRoundingMode(RoundingMode.HALF_UP); //设置舍入模式
        ...
        DisplayMetrics metrics1 = UserMapActivity.mContext.getResources().getDisplayMetrics();
...
//            nf.setRoundingMode(RoundingMode.HALF_UP); //设置舍入模式
        ...
        DisplayMetrics metrics2 = UserMapActivity.mContext.getResources().getDisplayMetrics();
    ...
    aaa (PieChart pieChart2,PieChart pieChart1,BarChart barChart,XAxis xAxis){
