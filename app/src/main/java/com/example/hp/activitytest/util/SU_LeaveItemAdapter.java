...
import com.example.hp.activitytest.activities.SU_LeaveInfo;
...
public class SU_LeaveItemAdapter extends RecyclerView.Adapter<SU_LeaveItemAdapter.ViewHolder> {
    ...
    public SU_LeaveItemAdapter(List<MessageLeaveApply> mMessageLeaveApplies){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, SU_LeaveInfo.class);
